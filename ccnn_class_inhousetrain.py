...
resting-state functional connectivity data to classify age category and saves 
the resulting weights and bias terms into 'weights_inhouse.pickle'.

This script was used for the classification condition 'backtransfer' in the manuscript
...
# Saving weights
pickle_file = "weights_inhouse.pickle"
