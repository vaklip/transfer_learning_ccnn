...
in the in-house dataset according to age category. All the weights and bias terms 
of the network are constants corresponding to the values learned previously on the 
public dataset.These weights and bias terms were generated by the script 
'ccnn_class_publictrain.py' and are stored in 'weights_public.pickle'. The results 
are saved into 'results_ccnn_class_CONVconstFULLconst.npz'.
