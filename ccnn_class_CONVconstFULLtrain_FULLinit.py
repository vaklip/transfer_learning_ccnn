...
connectivity matrices. The weights and bias terms of the convolutional layers 
are fixed and correspond to those learned previously on the public dataset, 
stored in 'weights_public'. The weights and bias terms of the fully connected 
...
and trained in each fold of the 10-fold cross-validation on the in-house dataset 
/ NKI-RS subset (folds are stored in 'folds_inhouse.npy' / 'folds_NKI-RS_subset.npy'). 
Results are saved into 'results_ccnn_class_CONVconstFULLtrain*.npz' 
and 'results_ccnn_class_CONVconstFULLtrain*.npz', respectively.  

This script was used for the conditions 'CONVconstFULLtrain' and 'CONVconstFULLinit' 
...
initmode = 2 # 1 = Randomly initializing the weights and bias terms of the fully 
             ...
             # biases of the convolutional layers are constants). 
             ...
             # in each fold of the cross-validation (weights and biases of the 
             # convolutional layers are constants).
...
# Save data
if initmode == 1:
    result_filename = "results_ccnn_class_CONVconstFULLtrain.npz"
elif initmode == 2:
    result_filename = "results_ccnn_class_CONVconstFULLinit.npz"
...
if initmode == 1:
    weight_filename = "weights_ccnn_class_CONVconstFULLtrain"
elif initmode == 2:
    weight_filename = "weights_ccnn_class_CONVconstFULLinit"
