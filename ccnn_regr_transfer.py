...
network on the in-house dataset to regress chronological age against resting-state 
functional connectivity matrices using 10-fold cross-validation (the folds are
stored in 'folds_inhouse.npy'). The weights and  biases of the convolutional layers 
